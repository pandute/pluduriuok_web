...
$(document).ready(function() {
    ...
    $("#fullpage").fullpage({
        ...
        navigationTooltips: ["Home", "Newsletter",  "What we'll offer", "Benefits",  "How it works", "in Research and Press"],
    ...
    $("#gallery-1").on("click", function() {
        $.swipebox([{
            href: "gallery/outside_standing.jpg",
            title: ""
        }, {
            href: "gallery/from_the_top.jpeg",
            title: ""
        }, {
            href: "gallery/float_water_scaled.jpg",
            title: ""
      }, {
        href: "gallery/inside.jpg",
        title: ""
      },
      {
        href: "gallery/entrance.jpg",
        title: ""
      }]);
    });
